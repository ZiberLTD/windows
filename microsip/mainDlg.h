...
public:
	...
	bool ziberMesternodeReady;
	CString ziberCountryCode;
	CList<CString> ziberBadMasternodes;
	CArray<ZiberNodeData> ziberMasternodes;
	ZiberDlg* ziberDlg;
	ZiberBonusCoinsDlg* ziberBonusCoinsDlg;
	...
	void RemoveJumpList();
	void MainPopupMenu();
	void ZiberAutoSelectNode();
	afx_msg LRESULT onZiberGetIPLoaded(WPARAM wParam,LPARAM lParam);
	void ZiberGetCountry(CString ip);
	afx_msg LRESULT onZiberGetCountryLoaded(WPARAM wParam,LPARAM lParam);
	void ZiberSelectNodeByGeo();
	void ZiberSelectNode(int index);
	int ZiberNodeIndexByIP(CString ip);
	void ZiberPingNode();
	afx_msg LRESULT onZiberPingNodeLoaded(WPARAM wParam,LPARAM lParam);
	void OnBnChangeZiberMasternode();
	void OnBnChangeZiberAuto();
...
public:
	...
	afx_msg void OnMenuZiberMasternodes();
