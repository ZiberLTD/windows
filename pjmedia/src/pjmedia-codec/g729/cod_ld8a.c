 ...
 *------------------------------------------------------------------------*/
  {
    ...
    Levinson_g729(r_h, r_l, Ap_t, rc);                 /* Levinson Durbin  */
  ...
  *------------------------------------------------------------------------*/
  ...
  for (i_subfr = 0;  i_subfr < L_FRAME; i_subfr += L_SUBFR)
  {
    ...
    *----------------------------------------------------------------------*/
    ...
    index = Enc_lag3_g729(T0, T0_frac, &T0_min, &T0_max,PIT_MIN,PIT_MAX,i_subfr);
    ...
    *-----------------------------------------------------------------*/
    ...
    gain_pit = G_pitch_g729(xn, y1, g_coeff, L_SUBFR);
