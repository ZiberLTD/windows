...
extern "C"
{
    ...
    */
    static Word32 L_add(register Word32 L_var1, register Word32 L_var2/*, Flag *pOverflow*/)
    {
        Word32 L_sum;
    ...
    */
    static Word32 L_sub(register Word32 L_var1, register Word32 L_var2/*,
...
//                *pOverflow = 1;
    ...
    */
    static Word32 L_mac(Word32 L_var3, Word16 var1, Word16 var2/*, Flag *pOverflow*/)
    {
        Word32 result;
        Word32 L_sum;
    ...
    */
    static Word32 L_mult(Word16 var1, Word16 var2/*, Flag *pOverflow*/)
    {
    ...
    */
    ...
    static Word32 L_msu(Word32 L_var3, Word16 var1, Word16 var2/*, Flag *pOverflow*/)
    {
        Word32 result;
    ...
    ------------------------------------------------------------------------------
     ...
     Returns:
        L_product = 32-bit product of L_var1 and L_var2 (Word32)
    */
    static Word32 Mpy_32(Word16 L_var1_hi,
                                Word16 L_var1_lo,
                                Word16 L_var2_hi,
                                Word16 L_var2_lo/*,
                                Flag   *pOverflow*/)
    ...
    */
    ...
    static Word32 Mpy_32_16(Word16 L_var1_hi,
                                   Word16 L_var1_lo,
                                   Word16 var2/*,
                                   Flag *pOverflow*/)
    {
    ...
    */
    static Word16 mult(Word16 var1, Word16 var2/*, Flag *pOverflow*/)
    {
    ...
    static Word32 amrnb_fxp_mac_16_by_16bb(Word32 L_var1, Word32 L_var2, Word32 L_var3)
    {
        Word32 result;
    ...
    static Word32 amrnb_fxp_msu_16_by_16bb(Word32 L_var1, Word32 L_var2, Word32 L_var3)
    {
        Word32 result;
